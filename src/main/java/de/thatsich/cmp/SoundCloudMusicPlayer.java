...
import de.thatsich.cmp.api.SoundCloudAPI;
import de.thatsich.cmp.connection.SoundCloudConnectionTester;
import de.thatsich.cmp.credential.SoundCloudClient;
import de.thatsich.cmp.credential.ConnectionManager;
...
public class SoundCloudMusicPlayer
{
	...
	public static void main( final String... args ) throws URISyntaxException, ClassNotFoundException, AuthorizationException, IOException
	{
		...
		if( connectionTester.isReachableWithTimeout( "https://soundcloud.com", 1000 ) )
		{
			...
			final SoundCloud soundCloud = new SoundCloudAPI( SoundCloudClient.ID, SoundCloudClient.SECRET, apiWrapper );
			//
